    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decision', models.CharField(choices=[('Good', 'G'), ('Bad', 'B'), ('Other', 'O')], max_length=20)),
                ...
                ('scan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='decisions', to='core.scan')),
            ],
            options={
                'ordering': ['-created'],
            },
