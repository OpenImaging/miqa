# Generated by Django 3.2 on 2021-04-13 21:35
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (miqa.core.models.scan.ScanDecision['NONE'], '-'),
                            (miqa.core.models.scan.ScanDecision['GOOD'], 'Good'),
                            (miqa.core.models.scan.ScanDecision['BAD'], 'Bad'),
                            (miqa.core.models.scan.ScanDecision['USABLE_EXTRA'], 'Usable extra'),
                        ],
                        default=miqa.core.models.scan.ScanDecision['NONE'],
                        max_length=20,
                    ),
                ),
                (
                ...
                (
                    'site',
                    models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.site'),
                ),
            ],
            options={
                'ordering': ['scan_id'],
